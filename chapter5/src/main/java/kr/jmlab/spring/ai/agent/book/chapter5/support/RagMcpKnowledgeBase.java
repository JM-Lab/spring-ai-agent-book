...
import kr.jmlab.spring.ai.agent.book.chapter5.support.RagDocumentLoader.PreparedDocuments;
...
@Component
@Profile("server")
public class RagMcpKnowledgeBase {

    private static final Logger logger = LoggerFactory.getLogger(RagMcpKnowledgeBase.class);
